...
"""))
    ...
    func testFloatingSidebarCanCollapseFromTitlebarButton() throws {
        ...
        XCTAssertTrue(shellSource.contains("return MomentoTheme.floatingSidebarInset + sidebarWidth - MomentoTheme.sidebarTitlebarButtonTrailingInset - MomentoTheme.sidebarTitlebarButtonSize"))
        XCTAssertTrue(shellSource.contains(".padding(.leading, sidebarToggleLeadingInset)"))
