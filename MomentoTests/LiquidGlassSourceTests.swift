...
"""))
    ...
    func testFloatingSidebarWidthIsUserResizableWithoutSplitViewBorders() throws {
        ...
        XCTAssertTrue(shellSource.contains("shellContent(availableWidth: geometry.size.width)"))
        XCTAssertTrue(shellSource.contains("private func shellContent(availableWidth: CGFloat) -> some View"))
        XCTAssertTrue(shellSource.contains(".frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .leading)"))
        XCTAssertTrue(shellSource.contains("floatingSidebar(availableWidth: availableWidth)"))
        XCTAssertTrue(shellSource.contains("private func floatingSidebar(availableWidth: CGFloat) -> some View"))
        XCTAssertTrue(shellSource.contains("private func sidebarResizeHandle(availableWidth: CGFloat) -> some View"))
        XCTAssertTrue(shellSource.contains("private func effectiveSidebarWidth(availableWidth: CGFloat) -> CGFloat"))
        XCTAssertTrue(shellSource.contains("private func sidebarWidthRange(availableWidth: CGFloat) -> ClosedRange<CGFloat>"))
        XCTAssertTrue(shellSource.contains("let inspectorWidth = isInspectorPresented ? MomentoTheme.inspectorWidth : 0"))
        XCTAssertTrue(shellSource.contains("availableWidth - MomentoTheme.contentMinWidth - inspectorWidth - MomentoTheme.floatingSidebarInset * 2"))
        XCTAssertTrue(shellSource.contains("min(MomentoTheme.sidebarMaxWidth, max(MomentoTheme.sidebarMinWidth, availableSidebarWidth))"))
        ...
        XCTAssertTrue(shellSource.contains(".frame(width: effectiveSidebarWidth(availableWidth: availableWidth))"))
        ...
        XCTAssertFalse(shellSource.contains(".clamped(to: MomentoTheme.sidebarMinWidth...MomentoTheme.sidebarMaxWidth)"))
        XCTAssertFalse(shellSource.contains("HSplitView"))
    }
    ...
    func testDraggingSidebarBelowMinimumCollapsesFloatingSidebar() throws {
        ...
        XCTAssertTrue(shellSource.contains("let widthRange = sidebarWidthRange(availableWidth: availableWidth)"))
    ...
    func testFloatingSidebarCanCollapseFromTitlebarButton() throws {
        ...
        XCTAssertTrue(shellSource.contains("buttonMinX: sidebarToggleButtonMinX(availableWidth: availableWidth)"))
        ...
        XCTAssertTrue(shellSource.contains("private func sidebarToggleButtonMinX(availableWidth: CGFloat) -> CGFloat"))
