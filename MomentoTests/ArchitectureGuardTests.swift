...
final class ArchitectureGuardTests: XCTestCase {
    ...
    func testSpacePreviewNavigationUsesSessionSnapshotAndArrowControls() throws {
        ...
        XCTAssertFalse(panelSource.contains(".id(\"\\(asset.id)-\\(previewURL.path)"))
        ...
        XCTAssertTrue(overlaySource.contains(".onChange(of: previewURL)"))
        XCTAssertFalse(overlaySource.contains("previewImage = nil"))
        ...
        XCTAssertTrue(overlaySource.contains("onNavigatePrevious: keyboardNavigatePreviousAction"))
        XCTAssertTrue(overlaySource.contains("onNavigateNext: keyboardNavigateNextAction"))
        XCTAssertTrue(overlaySource.contains("guard showsNavigationControls else"))
        ...
        XCTAssertTrue(overlaySource.contains("showNavigationBoundaryToast(localization.string(\"No previous image\"))"))
        XCTAssertTrue(overlaySource.contains("showNavigationBoundaryToast(localization.string(\"No next image\"))"))
