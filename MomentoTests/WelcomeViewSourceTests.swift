...
final class WelcomeViewSourceTests: XCTestCase {
    ...
    func testCreateLibraryDialogUsesReferenceGlassLayout() throws {
        ...
        XCTAssertTrue(source.contains("private let createLibraryDialogWidth: CGFloat = 520"))
        XCTAssertTrue(source.contains("private let createLibraryDialogIconSize: CGFloat = 52"))
        XCTAssertTrue(source.contains("private let createLibraryDialogFieldHeight: CGFloat = 44"))
        XCTAssertTrue(source.contains("HStack(alignment: .top, spacing: 18)"))
        ...
        XCTAssertTrue(source.contains(".font(.system(size: 20, weight: .semibold))"))
        XCTAssertTrue(source.contains(".font(.system(size: 14, weight: .regular))"))
        XCTAssertTrue(source.contains(".font(.system(size: 15, weight: .regular))"))
        XCTAssertTrue(source.contains(".font(.system(size: 15, weight: .semibold))"))
        XCTAssertTrue(source.contains(".frame(width: 132, height: 44)"))
        XCTAssertTrue(source.contains(".frame(width: 220, height: 44)"))
