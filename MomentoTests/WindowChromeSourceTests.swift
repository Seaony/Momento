...
final class WindowChromeSourceTests: XCTestCase {
    ...
    func testSidebarLibraryMenuUsesCustomGlassLibrarySwitcher() throws {
        ...
        XCTAssertTrue(themeSource.contains("static let librarySwitcherWidth: CGFloat = 420"))
        ...
        XCTAssertTrue(switcherMenuSource.contains(".frame(height: 32)"))
        XCTAssertTrue(switcherMenuSource.contains("if isSelected || isHovered"))
        XCTAssertTrue(switcherMenuSource.contains("shape.fill(MomentoTheme.sidebarIconHoverBackground)"))
        XCTAssertFalse(switcherMenuSource.contains("Color.accentColor"))
