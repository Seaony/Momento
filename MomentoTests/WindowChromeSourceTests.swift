...
final class WindowChromeSourceTests: XCTestCase {
    ...
    func testSidebarLibraryMenuUsesCustomGlassLibrarySwitcher() throws {
        ...
        XCTAssertTrue(themeSource.contains("static let librarySwitcherWidth: CGFloat = 340"))
        ...
        XCTAssertTrue(switcherMenuSource.contains("isSelected ? MomentoTheme.secondaryText : MomentoTheme.tertiaryText"))
