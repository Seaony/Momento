...
final class WindowChromeSourceTests: XCTestCase {
    ...
    func testSidebarLibraryMenuUsesCustomGlassLibrarySwitcher() throws {
        ...
        let switcherMenuEnd = try XCTUnwrap(sidebarSource[switcherMenuStart.lowerBound...].range(of: "private extension View {"))
        ...
        XCTAssertTrue(themeSource.contains("static let librarySelectorHeight: CGFloat = 26"))
        XCTAssertTrue(themeSource.contains("static let librarySwitcherVerticalGap: CGFloat = 8"))
        XCTAssertTrue(libraryMenuSource.contains(".frame(height: MomentoTheme.librarySelectorHeight)"))
        ...
        XCTAssertTrue(switcherMenuSource.contains("MomentoGlassBackground(glass: .regular, cornerRadius: 12)"))
        XCTAssertFalse(switcherMenuSource.contains("MomentoGlassBackground(glass: .regular.tint(Color.white.opacity(0.08)), cornerRadius: 12)"))
        ...
        XCTAssertTrue(switcherOverlaySource.contains(".padding(.top, MomentoTheme.floatingSidebarTitlebarContentInset + MomentoTheme.librarySelectorHeight + MomentoTheme.librarySwitcherVerticalGap)"))
        XCTAssertFalse(switcherOverlaySource.contains("MomentoTheme.floatingSidebarTitlebarContentInset + 42"))
