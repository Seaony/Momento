...
final class WindowChromeSourceTests: XCTestCase {
    ...
    func testSidebarLibraryMenuUsesCustomGlassLibrarySwitcher() throws {
        ...
        XCTAssertTrue(themeSource.contains("static let librarySwitcherWidth: CGFloat = 380"))
        ...
        XCTAssertTrue(switcherMenuSource.contains(".foregroundStyle(MomentoTheme.tertiaryText)"))
