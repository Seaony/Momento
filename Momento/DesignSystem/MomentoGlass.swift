...
enum MomentoTheme {
    ...
    static let sidebarTitlebarButtonTopInset: CGFloat = 13
    ...
    static let mainWindowMinWidth = sidebarMaxWidth + floatingSidebarInset * 2 + contentMinWidth + contentSidebarGap * 2 + inspectorWidth
